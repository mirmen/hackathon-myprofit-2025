...
// in coffeebook/test/user_provider_test.dart.
...
class _FakePostgrestQueryBuilder_22<T1> extends _i1.SmartFake
    implements _i2.PostgrestQueryBuilder<T1> {
  _FakePostgrestQueryBuilder_22(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockPostgrestQueryBuilder<T> extends _i1.Mock
  ...
  _i2.PostgrestQueryBuilder<T> setHeader(String? key, String? value) =>
      (super.noSuchMethod(
            Invocation.method(#setHeader, [key, value]),
            returnValue: _FakePostgrestQueryBuilder_22<T>(
              this,
              Invocation.method(#setHeader, [key, value]),
            ),
          )
